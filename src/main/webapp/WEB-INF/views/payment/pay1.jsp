...
<script type='text/javascript'>
	...
	var tid = "<c:out value='${responseDomain.tid}'/>";
	var next_redirect_app_url = "<c:out value='${responseDomain.next_redirect_app_url}'/>";
	var next_redirect_mobile_url = "<c:out value='${responseDomain.next_redirect_mobile_url}'/>";
	var next_redirect_pc_url = "<c:out value='${responseDomain.next_redirect_pc_url}'/>";
	var created_at = "<c:out value='${responseDomain.created_at}'/>";
...
/*         alert("tid2 : " + tid);
        alert("next_redirect_app_url : " + next_redirect_app_url);
        alert("next_redirect_mobile_url : " + next_redirect_mobile_url);
        alert("next_redirect_pc_url : " + next_redirect_pc_url);
 ...
 */        
        if(agent === 'web'){
            ...
            location.href = next_redirect_mobile_url;
        }
