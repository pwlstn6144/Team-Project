    ...
    <form name="modify_form" action="modify" method="post">
		<table class="table table-bordered">			
			...
			<tr>
				...
				<td> <input type="hidden" name="bName" value="${content_view.bName}">${content_view.bName}</td>
			</tr>
			<tr>
				<th class="table-light">
				<nav class="nav justify-content-center" >
		...
		<nav class="nav justify-content-end" >
			<button type="button" class="btn btn-outline-success" aria-haspopup="true"  onclick="form_check();">수정완료</button>&nbsp;&nbsp;
			<button type="button" class="btn btn-outline-danger" aria-haspopup="true"  onclick="javascript:window.location='service_view?bId=${content_view.bId}'">취소</button>&nbsp;&nbsp;
			<button type="button" class="btn btn-outline-primary" aria-haspopup="true"  onclick="javascript:window.location='QandA?page=<%=session.getAttribute("cpage")%>'">목록보기</button>&nbsp;&nbsp;
		</nav>
	</form>
