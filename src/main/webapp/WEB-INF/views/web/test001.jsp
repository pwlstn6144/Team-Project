...
<script>  
	function openChatt(){  
	    window.open("http://localhost:8081/spring/chatt", "관리자 대화방", "width=1200, height=850, toolbar=no, menubar=no, scrollbars=no, resizable=yes" );  
	}  
...
<div class="container">
	<header class="blog-header py-3">
      ...
      <div class="row flex-nowrap justify-content-between align-items-center">
			<div class="col-4 pt-1">
       		...
       		<div class="col-4 text-center">
       			<a class="blog-header-logo text-dark" href="test001">현재 기사 위치 조회</a>
	...
	<div class="map_wrap" style="margin-left:100px;">
		...
		<div class="category">
	        <ul>
	            <li id="coffeeMenu" onclick="findKisa('0')">
	                <span class="ico_comm ico_coffee"></span>
	                배송대기
	            </li>
	            
	            <li id="coffeeMenu" onclick="findKisa('1')">
	                <span class="ico_comm ico_store"></span>
	                배송중
	            </li>
	            
	            <li id="coffeeMenu" onclick="findKisa('2')">
