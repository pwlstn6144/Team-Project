...
<div class="container">
	<header class="blog-header py-3">
       ...
       <%if(member == null || member.equals("customer") || member.equals("worker")){ %>
        ...
        <br />
	<form name="write_form" action="serviceWrite" method="post">
		<table class="table table-bordered">	
			<tr>
				<th class="table-info">아이디</th>
				<td> <input type="hidden" name="bName" value="${bName}">${bName}</td>
			</tr>
			<tr>
		...
		<nav class="nav justify-content-center" >  
			<button type="button" onclick="form_check()" class="btn btn-outline-primary">입력</button>
			<button type="button" onclick="qnaList()" class="btn btn-outline-success">목록보기</button>
		</nav>
	</form>
