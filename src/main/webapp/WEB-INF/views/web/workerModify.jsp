...
<%
session.setAttribute("bUrl", "workerModify"); 
...
<script>
	function pw_check(){
		var wk_Password = document.getElementById("wk_Password");
		var wk_Password2 = document.getElementById("wk_Password2");
		
		if(!(wk_Password.value == wk_Password2.value)){
			alert("비밀번호가 틀렸습니다.");
			wk_Password2.value="";
			wk_Password2.focus();
			return;
	...
	<header class="blog-header py-3">
      ...
      <div class="row flex-nowrap justify-content-between align-items-center">
			<div class="col-4 pt-1">
       		...
       		<div class="col-4 text-center">
            	<a class="blog-header-logo text-dark" href="workerList">기사 정보 수정</a>
        	</div>
        	<div class="col-4 d-flex justify-content-end align-items-center">
        	</div>
       </div>
       ...
       <%if(member == null || member.equals("customer") || member.equals("worker")){ %>
        ...
        <br />
	<form name="modifyWorker" method="post" action="workerModifyView" enctype="multipart/form-data">
		<table class="table table-bordered">
			<tr>
				<th colspan="2">
					<img src="resources/upload/${dto.wk_Picture}" width="300" height="300"/><br>
					<input type="file" id="userfile1" name="userfile1" value="${dto.wk_Picture}" />
				</th>
			</tr>
			<tr>
				<th class="table-success">이름</th>
				<td><input type="text" id="wk_Name" name="wk_Name" value="${dto.wk_Name}"></td>
			</tr>
			<tr>
				<th class="table-success">아이디</th>
				<td><input type="hidden" id="wk_Id" name="wk_Id" value="${dto.wk_Id}">${dto.wk_Id}</td>
			</tr>
			<tr>
				<th class="table-success">비밀번호</th>
				<td><input type="password" id="wk_Password" name="wk_Password" value="${dto.wk_Password}"></td>
			</tr>
			<tr>
				<th class="table-success">비밀번호 확인</th>
				<td><input type="password" id="wk_Password2" name="wk_Password2" value="${dto.wk_Password}"></td>
			</tr>
			<tr>
				<th class="table-success">전화번호</th>
				<td><input type="text" id="wk_Phone" name="wk_Phone" placeholder="-은 제외하고 입력하세요." value="${dto.wk_Phone}"></td>
			</tr>
			<tr>
				<th class="table-primary" colspan="2">
					<button type="button" class="btn btn-success" onclick="pw_check()">다음</button>
