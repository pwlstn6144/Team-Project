...
<%
session.setAttribute("bUrl", "workerModifyView"); 
...
<div class="container">
	...
	<form name="modifyView" action="modifyResult" method="post" enctype="multipart/form-data">
		<table class="table table-bordered">
		<tr>
			<th colspan="2">
				<input type="hidden" name="saveFileName" id="saveFileName" value="${returnObj.saveFileName }">
				<img src="resources/upload/${returnObj.saveFileName }" width="300" height="300" />
			</th>
		</tr>
		<tr>
			<th class="table-success">이름</th>
			<td><input type="hidden" name="wk_Name" id="wk_Name" value="${returnObj.wk_Name}">${returnObj.wk_Name}</td>
		</tr>
		<tr>
			<th class="table-success">아이디</th>
			<td><input type="hidden" name=wk_Id id="wk_Id" value="${returnObj.wk_Id}">${returnObj.wk_Id}</td>
		</tr>
		<tr>
			<th class="table-success">비밀번호</th>
			<td><input type="hidden" name="wk_Password" id="wk_Password" value="${returnObj.wk_Password}">${returnObj.wk_Password}</td>
		</tr>
		<tr>
			<th class="table-success">전화번호</th>
			<td><input type="hidden" name="wk_Phone" id="wk_Phone" value="${returnObj.wk_Phone}">${returnObj.wk_Phone}</td>
		</tr>
		<tr>
			<th class="table-primary" colspan="2">
				<button type="button" class="btn btn-success" onclick="infoModify()">수정하기</button>				
			</th>
		</tr>
		</table>
	</form>
