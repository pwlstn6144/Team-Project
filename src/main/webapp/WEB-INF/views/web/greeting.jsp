<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
session.setAttribute("bUrl", "greeting"); 
...
<div class="container">
	<header class="blog-header py-3">
        ...
        <div class="col-4 text-center">
      	...
      	<div class="row flex-nowrap justify-content-between align-items-center">
			<div class="col-4 pt-1">
       		...
       		<div class="col-4 text-center">
            	<a class="blog-header-logo text-dark" href="greeting">인사말</a>
        	</div>
        	<div class="col-4 d-flex justify-content-end align-items-center">
        	</div>
       </div>
        ...
        <div class="container">
        	<div class="row">
        		 <div class="col">
        		 	<img src="./picture/jibaeIn2.png" style="width:200px; height:200px">
        		 </div>
        		  <div class="col-9">
        		  	고객 여러분! 안녕하십니까?<br>
        		  	저희 지배인 지하철 택배 서비스 홈페이지를 방문해 주셔서 감사합니다.<br>
        		  	저희 회사는 고령자의 자립과 근로를 원하는 사람들의 일자리 창출을 도모하는 사회적 순기능의 역할을<br>
        		  	하고자 시작했습니다.<br>
        		  	창립 이후 체계적인 직원 관리와 철저한 친절 교육으로 이용 고객들의 호평과 사랑을 꾸준히 받아 왔습니다.<br>
        		  	저희 회사는 날로 세분화되고 신속함을 요구하는 현재의 택배시장에 수도권의 방대한 교통 시스템을 이용<br>
        		  	하여 고객님의 소화물을 저렴한 배송 비용으로 안전, 신속하게 논스톱으로 배송하는 생활 편의 서비스를<br>
        		  	제공하고 있습니다.<br>
        		  	서울 및 수도권 전지역에 배송 담당 직원들을 분산 배치시켜 고객님이 의뢰한 일을 보다 빠르고 정확하게<br>
        		  	고객님이 원하는 곳이면 어디든지 배송해 드리고 있습니다. 또한 철저히 1 : 1 배송을 원칙으로 하고 있으며<br>
        		  	항상 최선을 다해 안전하게 고객님의 물품을 마음까지 담아 배송해 드릴 것을 약속 드립니다.
        		 	<br> 특송 시장의 가장 편안하고 믿음직한 지하철 택배 서비스 브랜드로 성장할 수 있도록 고객님의 성원과 격려<br>
        		 	부탁드리며, 그에 걸맞는 질 높은 서비스를 제공하기 위해 항상 노력하는 모습 보여드리겠습니다.<br>
        		 	감사합니다. 
        		  </div>
        	</div>
        </div>
